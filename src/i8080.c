...
/* xD */ {"RNC",     getNULL,       getNULL,    RNC, 1}, {"POP D",      getSingleReg16, getNULL,    POP, 1}, {"JNC a16", getImm16,       getNULL,    JNC,  3}, {"OUT d8",  getImm8,        getNULL,    OUT,  2}, {"CNC a16", getImm16,      getNULL,    CNC, 3}, {"PUSH D",   getSingleReg16, getNULL,    PUSH, 1}, {"SUI d8",   getImm8,       getNULL,    SUI, 2}, {"RST 2",   getRST,        getNULL,    RST, 1}, {"RC",      getNULL,       getNULL,    RC,  1}, {"RET",     getNULL,        getNULL,    RET,  1}, {"JC a16",   getImm16,       getNULL,    JC,   3}, {"IN d8",   getImm8,        getNULL,    IN,   2}, {"CC a16",  getImm16,      getNULL,    CC,  3}, {"CALL a16", getImm16,      getNULL,    CALL, 3}, {"SBI d8",   getImm8,       getNULL,    SBI, 2}, {"RST 3",   getRST,        getNULL,    RST, 1},
